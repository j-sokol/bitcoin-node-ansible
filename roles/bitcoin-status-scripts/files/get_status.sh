...
while true; do \
	prevblocks=$blocks
	bestblockhash=`bitcoin-cli -datadir=/mnt/bitcoin getbestblockhash`; \
	blockts=`bitcoin-cli -datadir=/mnt/bitcoin getblock $bestblockhash | jq .time`; \
	...
	blocks=`bitcoin-cli -datadir=/mnt/bitcoin getblockcount`; \
